...
//         gameService = new SoloGameService(gridService, rackService, chatDisplayServiceSpy, validationService, wordBuilderService, placeService);
...
//     //     const defaultParams = { player: gameServiceSpy.currentGameService.game.localPlayer, serviceCalled: gameServiceSpy };
